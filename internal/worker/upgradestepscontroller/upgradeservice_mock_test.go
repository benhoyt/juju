...
//
//	mockgen -typed -package upgradestepscontroller -destination upgradeservice_mock_test.go github.com/juju/juju/internal/worker/upgradestepscontroller UpgradeService
//
